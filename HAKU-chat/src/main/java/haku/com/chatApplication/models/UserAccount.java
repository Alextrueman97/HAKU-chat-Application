 ...
 * @Entity
 * 
 * @Table(name = "user_account") public class UserAccount {
 * 
 * @Id
 * 
 ...
 * 
 * public UserAccount(int accountId, String username, String email, String
 * password, String avatarUrl) { super(); this.accountId = accountId;
 * this.username = username; this.email = email; this.password = password;
 * this.avatarUrl = avatarUrl; }
 * 
 * public UserAccount(int accountId, String username, String email, String
 * password, String avatarUrl, UserRole role) { super(); this.accountId =
 * accountId; this.username = username; this.email = email; this.password =
 * password; this.avatarUrl = avatarUrl; this.role = role; }
 * 
 * public UserAccount(String username, String email, String password, UserRole
 * role) { super(); this.username = username; this.email = email; this.password
 * = password; this.role = role; }
 * 
 * public UserAccount(String email, String password) { super(); this.email =
